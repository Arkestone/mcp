---
title: mcp-graph — Knowledge Graph MCP Server
sidebar_label: mcp-graph
---
...
See [`config.example.yaml`](https://github.com/Arkestone/mcp/blob/main/servers/mcp-graph/config.example.yaml) for all options.
